...
// x範囲を狭く（-38〜+38）、y範囲を縮小（-46〜+46）でカードの視認性確保
// 縦画面ではカード回転なし（angle=0）
export const SEAT_POSITIONS_6_PORTRAIT: SeatPosition[] = [
  // 0: 下中央（自分）
  { x: 0, y: 46, angle: 0, betOffset: { x: 0, y: -20 } },
  // 1: 左下
  { x: -38, y: 22, angle: 0, betOffset: { x: 18, y: -10 } },
  // 2: 左上
  { x: -38, y: -22, angle: 0, betOffset: { x: 18, y: 10 } },
  // 3: 上中央
  { x: 0, y: -46, angle: 0, betOffset: { x: 0, y: 20 } },
...
// y範囲を縮小（-46〜+46）でカードの視認性確保
export const SEAT_POSITIONS_8_PORTRAIT: SeatPosition[] = [
  // 0: 下中央
  { x: 0, y: 46, angle: 0, betOffset: { x: 0, y: -20 } },
  // 1: 左下
  { x: -34, y: 32, angle: 0, betOffset: { x: 16, y: -10 } },
  // 2: 左
  { x: -42, y: 4, angle: 0, betOffset: { x: 18, y: 0 } },
  // 3: 左上
  { x: -34, y: -25, angle: 0, betOffset: { x: 16, y: 10 } },
  // 4: 上中央
  { x: 0, y: -46, angle: 0, betOffset: { x: 0, y: 20 } },
  // 5: 右上
  { x: 34, y: -25, angle: 0, betOffset: { x: -16, y: 10 } },
